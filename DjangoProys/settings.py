"""
Django settings for DjangoProys project.
...
SECRET_KEY = 'django-insecure-v1b=6#=k6&dyhm97i50ujkuj=53-tat48as$uex(4g8+)9ychu'
...
WSGI_APPLICATION = 'DjangoProys.wsgi.application'
